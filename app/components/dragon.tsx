export default function Dragon() {
  return (
    <svg
      ...
      viewBox="0 0 260 174"
      enableBackground="new 0 0 260 174"
      xmlSpace="preserve"
      stroke="#ffffff"
    >
